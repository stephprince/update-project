...
if ~isempty(dataTable)
    if ~exist(filename1) || ~exist(filename2) %|| makenewfiles    
     ...
     trialArrayHeaders = {'trialNum','trialStart','trialEnd', 'trialDur', 'trialOutcomes', 'trialTypesLeftRight', 'trialDelayLocation','trialUpdateLocation','trialDelayDuration', 'trialTypesUpdate', 'trialWorld', 'resampledTrialData'};
     trialArray = nan(2,numel(trialArrayHeaders));
     trialTable = array2table(trialArray,'VariableNames',trialArrayHeaders);
     resampledData = nan;
end
