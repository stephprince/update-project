...
class BayesianDecoderVisualizer(BaseVisualizationClass):
    ...
    def plot_decoding_output_heatmap(self, sfig, update_type='switch', prob_value='prob_sum', feat='position',start_nan=False):
        # load up data
        ...
        mask = np.isnan(features2)| (features2 <= 6)
    ...
    def plot_goal_coding_stats(self, sfig, comparison='update_type', prob_value='prob_sum', title='', tags='',
        ...
        combo_list = [label_map[g] for g in plot_groups[comparison]]#i want combo_list to be 
