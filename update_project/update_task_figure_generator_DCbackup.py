...
class UpdateTaskFigureGenerator:
    ...
    def plot_figure_2(self, with_supplement=True):
        ...
        if with_supplement:
            ...
            ##### supp figure 4#now sfig 5, needs additions#
            n_sfig = 5
    ...
    def plot_supp_figure_all_trials(self):
        ...
        sfigs[1] = hpc_visualizer_encode_all.plot_goal_coding(sfigs[1], tags='sfig5_CA1_position_all')#
        #
